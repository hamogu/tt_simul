...
;
;  $Id: ddeabm.pro,v 1.25 2004/04/19 06:23:40 craigm Exp $
;-
; Portions Copyright (C) 2002, 2003, 2004, Craig Markwardt
...
; C***FIRST EXECUTABLE STATEMENT  DDEABM
      ...
      init = keyword_set(init0)
      if n_elements(state) EQ 0 then init = 1L

      ;; Construct the INFO array from keywords
      INFO = [ 1 - KEYWORD_SET(INIT), n_elements(rtol) GT 1, $
