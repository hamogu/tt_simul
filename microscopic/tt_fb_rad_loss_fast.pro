...
; CALLING SEQUENCE:
;
;      fb_rad_loss_fast, temp, int, min_abund=min_abund, /no_setup
;
; OUTPUTS
;
...
;       READ_FBLVL, CONCAT_DIR
;
; EXAMPLES
;
;       IDL> fb_rad_loss_fast,temp,int
;       IDL> plot,temp,int,/xlog,/ylog
;
; MODIFICATION HISTORY:
;
;     3-may-2005, Moritz Günther
;		changed call to get_ieq to directly use the 2-dim ioneq from tt_simul
...
PRO tt_fb_rad_loss_fast, temp, int, min_abund=min_abund, $
                    no_setup=no_setup
